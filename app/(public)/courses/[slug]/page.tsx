      ...
      <div className="order-1 lg:col-span-2">
        ...
        <div className="mt-8 space-y-6">
          <div className="space-y-4">
            <h1 className=" text-xl font-bold  tracking-light">
              {course.title}
            </h1>

            <p className="text-lg line-clamp-2 leading-relaxed text-muted-foreground">
              {" "}
          ...
          <div className="space-y-6">
            ...
            <div>
              <RenderDescription html={course.description} />
            </div>
              ...
              <div className="space-y-4 ">
                {course.chapters.map((chapter, index) => (
                  <Collapsible key={chapter.id} defaultOpen={index === 0}>
                    <Card className="p-0 transition-all duration-200 hover:shadow-md gap-0">
                      <CollapsibleTrigger>
                        <div>
                      ...
                      <CollapsibleContent>
                        <div className="border-t bg-muted/20">
                          <div className="p-6 p-t-4 space-y-3">
                            {chapter.lessons.map((lesson, index) => (
                              <div
                                key={lesson.id}
                                className="flex items-center gap-4 rounded-lg transition-colors hover:bg-accent group"
                              >
                                <div className="flex items-center justify-center size-8 rounded-full bg-background border-primary/20 border-2">
                                  <IconPlayerPlay className="size-5 text-muted-foreground group-hover:text-primary transition-colors"></IconPlayerPlay>
                                </div>
